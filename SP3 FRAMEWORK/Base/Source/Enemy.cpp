...
void Enemy::Update(double dt)
{
	...
	switch (State)
	{
		case ENEMY_STATE::PATROL:
		{
			...
			if (distance_to_player <= 250 && AttackCD <= 0.0f)
			{
				AttackCD = 1.0f;
				...
				case ENEMY_TYPE::GHOST_1:
				{
					...
					ghost->play3D("Sound/ghost1.mp3", irrklang::vec3df(pos.x, pos.y, pos.z));
				...
				case ENEMY_TYPE::GHOST_2:
				{
					...
					ghost->play3D("Sound/ghost2.mp3", irrklang::vec3df(pos.x, pos.y, pos.z));
				...
				case ENEMY_TYPE::GHOST_3:
				{
					...
					ghost->play3D("Sound/ghost3.mp3", irrklang::vec3df(pos.x, pos.y, pos.z));
